          ...
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            ...
            >
              ...
              <li>
                ...
                >
                  <i className="fs-4 bi-people"></i>{" "}
                  <span className="ms-1 d-none d-sm-inline">Manage Tl</span>{" "}
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <i className="fs-4 bi-people"></i>{" "}
                  <span className="ms-1 d-none d-sm-inline">Manage Hr</span>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <i className="fs-4 bi-people"></i>{" "}
                  <span className="ms-1 d-none d-sm-inline">Manage Projects</span>{" "}
                </Link>
              </li>
              <li>
                <Link
