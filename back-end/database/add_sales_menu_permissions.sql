...
-- This script adds the Sales Department parent menu and its submenus

-- Parent Menu: Sales Department
INSERT INTO `menu_permissions` (`menu_key`, `menu_title`, `menu_path`, `menu_icon`, `parent_menu`, `allowed_roles`, `is_active`, `display_order`) 
VALUES ('sales', 'Sales Department', '/Dashboard/Sales', 'Business', NULL, '["Admin"]', TRUE, 5)
...
-- Submenu: Lead List
INSERT INTO `menu_permissions` (`menu_key`, `menu_title`, `menu_path`, `menu_icon`, `parent_menu`, `allowed_roles`, `is_active`, `display_order`) 
VALUES ('lead_list', 'Lead List', '/Dashboard/Sales/LeadList', 'People', 'sales', '["Admin"]', TRUE, 5.4)
ON DUPLICATE KEY UPDATE 
  menu_title = VALUES(menu_title),
  menu_path = VALUES(menu_path),
  menu_icon = VALUES(menu_icon),
